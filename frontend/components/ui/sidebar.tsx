...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'border-outline-variant/20 fixed top-0 left-0 z-50 h-full w-60 border-r bg-slate-900/40 p-4 transition-transform duration-200 md:static md:z-auto md:h-[calc(100vh-4rem)]',
